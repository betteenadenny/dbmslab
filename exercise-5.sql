...
create trigger updateAvaliableQuantityOne after insert on saleitem for each row update product set product.qtyinstock=product.qtyinstock-new.qtyinstock where product.pdtid = new.pdtid;
select * from product;
insert into saleitem values (1,101,5);
